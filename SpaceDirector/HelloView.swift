        ...
        NavigationStack {
            ZStack {
                if showText1 || showText2 || showText3 {
                    ...
                    if showText1 {
                        ZStack {
                            RegularTextView(text: "Привет", color: .white, size: 30)
                                .transition(.opacity.animation(.easeIn(duration: 1.0)))
                            RegularTextView(text: "tap  here :)", color: .white, size: 15)
                                .padding(.top, 300)
                                .transition(.opacity.animation(.easeIn(duration: 1.0)))
                        }
                    }
                    ...
                    if showText2 {
                        RegularTextView(text: "Меня зовут Рони", color: .white, size: 30)
                            .transition(.opacity.animation(.easeIn(duration: 1.0)))
                    }
                    
                    if showText3 {
                        RegularTextView(text: "И сейчас я постараюсь продемонстрировать вам часть технологий, которыми я владею", color: .white, size: 30)
                            .padding()
                            .transition(.opacity.animation(.easeIn(duration: 1.0)))
                    ...
                    ZStack {
                        ...
                        VStack (alignment: .leading, spacing: 25) {
                            if showText4 {
                                RegularTextView(text: "Предлагаю представить, что вы студент-астрофизик из NASA", color: .white, size: 25)
                                    .transition(.opacity.animation(.easeIn(duration: 1.0)))
                                BarbButtonView(title: "Ну допустим", action: { showText5 = true }, width: 168, height: 47)
                                    .transition(.opacity.animation(.easeIn(duration: 1.0).delay(1.5)))
                            }
                            if showText5 {
                                RegularTextView(text: "И это ваш личный кабинет в приложении агенства", color: .white, size: 25)
                                    .transition(.opacity.animation(.easeIn(duration: 1.0)))
                            ...
                            if showText6 {
                                RegularTextView(text: "Все-все, не томлю, заходите :)", color: .white, size: 25)
                                    .padding(.trailing)
                                    .transition(.opacity.animation(.easeIn(duration: 1.0)))
